...
PiFeed is a system of connected Raspberry Pi units that allow the user to care for their cat and/or fish locally and/or remotely. The PiFeed system is capable of maintaining a feeding schedule and setting food for your pet cats and/or fish. The PiFeed system also allows the user to manually control when a feeding occurs by accessing the feeder via web service. Both the cat feeder and fish feeder may be monitored through the use of a Raspberry Pi camera and may be seen via web service. For the cat feeder, a sensor is used to detect the presence of a cat and allows the distribution of food once detected.
...
\begin{itemize}
\item Name: Danny Duangphachanh: \href{mailto:bboydd@vt.edu}{bboydd@vt.edu}
\item Name: Daniel Friedman: \href{mailto:adfriedman@vt.edu}{adfriedman@vt.edu}
\item Name: Igor Janjic: \href{mailto:ijanjic@vt.edu}{ijanjic@vt.edu}
\end{itemize}
